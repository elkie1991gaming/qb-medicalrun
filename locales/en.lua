local Translations = {
    error = {
        ...
        cancelled = "Cancelled",
        vehicle_not_correct = "This is not an Emergency Vehicle!",
    ...
    mission = {
        ...
        take_box = "Take A Box Of Medical Supplies",
        deliver_box = "Deliver Box Of Medical Supplies",
        another_box = "Get another Box Of Medical Supplies",
        goto_next_point = "You Have Delivered All Medical Supplies, To The Next Point",
        return_to_station = "You Have Delivered All Medical Supplies, Return to Station",
        job_completed = "You Have Completed Your Route, Please Collect Your Pay Cheque"
    },
    info = {
        deliver_e = "~g~E~w~ - Deliver Medical Supplies",
        deliver = "Deliver Medical Supplies",
    }
}
